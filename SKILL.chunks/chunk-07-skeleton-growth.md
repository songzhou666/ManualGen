...
| 仍 <0.7 且 AI 判定"操作可推断" | WRITE 阶段对应位置加 ⚠️ 提示语（不写虚假按钮/明确操作语句） | INFERRED_WITH_WARNING |
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
1. 6层进度仪表盘
   模块 7/7 (L0✓ L1✓ L2✓ L3 89% L4 67% L5 52%)
...
2. 最近 20 条 AI 自主裁决（来自 _auto_decisions.md）
   ...
   AD-022 INFERRED_WITH_WARNING: FN_103「批量导出」 0.41 → 写 ⚠️ 推断语句
   ...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
3. ⚠️ 待人工复核 Top（requires_human_review=true 节点）
