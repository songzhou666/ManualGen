...
3. 所有 confidence < 0.7 的节点引用都要加 ⚠️ 前缀。
...
> ⚠️ 本模块中 12% 节点基于置信度传播或推断，已标记 ⚠️ 提示，建议对核心功能人工复核
...
| 修改价格 | ✅ | ❌ | ❌ | ❌⚠️（推断） |
| ... | ... | ... | ... | ... |
> 来源：`_kb/L5_details/ROLE/权限矩阵.json` · 覆盖率 86% · 4项推断已标记 ⚠️（推断记录见 `_kb/_auto_decisions.md`）
...
| STEP_00104 | 明细行添加商品 | ≥1 行；商品匹配 ENT_产品 库存>0 | 库存不足→标红 + 阻止继续 ⚠️（推断，证据仅前端check） |
| ... | ... | ... | ... |
...
| orderLines[].productId | 整数 | ✅ | ≥1 & 库存>0⚠️ | — | ENT_产品 |
...
**版本**: 6.1.0-agent04-module-writer
**最后更新**: 2026-08-11
