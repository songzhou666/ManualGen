...
> ⚠️ **隐私保护**：本文档必须遵守 [privacy/privacy-notice.md](../privacy/privacy-notice.md) 的隐私规则。严禁包含账号/密码/Token/API Key/隐私数据。
>
...
> ⚠️ **风险提示**：{操作名称}为{高危操作类型}，提交后{不可逆/不可撤销/需审核}，请确认无误后再操作。
