# ManualGen v6.1.0 · 智能业务分析与操作手册生成专家
...
→ AI 开启「核心优先模式」，核心模块 L0-L5 全量写完手册，非核心模块停在 L2 作背景。
...
├── 1-manifest/skill-manifest.yaml        # Skill 元数据（version 6.1.0）
└── CHANGELOG.md                          # 版本变更日志
```
...
| 版本 | 日期 | 核心变化 |
|------|------|---------|
| v6.1.0 | 2026-08-11 | 全流程自主托管：AUTO_REVIEW 取代 CONFIRM、JUDGE 模块级打回、AUDIT 10 维度、产物路径统一、附录 B~E 模板、Refiner/Judge Agent 补齐 |
